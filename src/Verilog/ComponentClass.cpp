...
Component* Component::castToSubClass(Component* component){
	if(type == COMPONENT_START){
		...
		if(op == OPERATOR_ADD){
			...
			component = (Component *)obj;
			return component;
		} else if(op == OPERATOR_FEXP){
			FexpComponent* obj = new FexpComponent(*this);
			component = (Component *)obj;
			return component;
		} else if(op == OPERATOR_FLOG){
			FlogComponent* obj = new FlogComponent(*this);
			component = (Component *)obj;
			return component;
		} else if(op == OPERATOR_FSQRT){
			FsqrtComponent* obj = new FsqrtComponent(*this);
			component = (Component *)obj;
			return component;
		}
		...
		component = (Component *)obj;
		return component;
	} else if(type == COMPONENT_DISTRIBUTOR){
		DistributorComponent* obj = new DistributorComponent(*this);
		component = (Component *)obj;
		return component;
	} else if(type == COMPONENT_SELECTOR){
		SelectorComponent* obj = new SelectorComponent(*this);
		component = (Component *)obj;
		return component;
	}else if(type == COMPONENT_ROUTER){
		RouterComponent* obj = new RouterComponent(*this);
		component = (Component *)obj;
		return component;
	}
...
void Component::setInputConnections(){
	for(int i = 0; i < in.size; i++)
	{
		...
		if(type == COMPONENT_ROUTER){
			inConn.data = name + "_in" + std::to_string(inputIndex) + "_" + "data";
			inConn.ready = name + "_in" + std::to_string(inputIndex) + "_" + "ready";
			inConn.valid = name + "_in" + std::to_string(inputIndex) + "_" + "valid";
		} else{
...
void Component::setOutputConnections(){
	for(int i = 0; i < out.size; i++)
	{
		...
		if(type == COMPONENT_ROUTER){
			outConn.data = name + "_out" + std::to_string(outputIndex) + "_" + "data";
			outConn.ready = name + "_out" + std::to_string(outputIndex) + "_" + "ready";
			outConn.valid = name + "_out" + std::to_string(outputIndex) + "_" + "valid";
		} else{
...
//Overridden by Const and Select and LoadComponent and StoreComponent and EndComponent and Selector
