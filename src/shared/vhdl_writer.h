...
//For NoC Support
#define COMPONENT_ROUTER 		"Router"
...
#define OPERATOR_FEXP			"fexp_op"
#define OPERATOR_FLOG			"flog_op"
#define OPERATOR_FSQRT			"fsqrt_op"


static std::vector<std::pair<std::string, int>> allFloatingPointComponents =
	...
	{OPERATOR_FEXP, 0}, {OPERATOR_FLOG, 0}, {OPERATOR_FSQRT, 0}
	//Template for New floating point operator
	//, {OPERATOR_<name>, 0}
	};
